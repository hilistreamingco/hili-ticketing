...
export default function ContactPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    setStatus("sending");
    try {
      const response = formspreeEndpoint
        ? await fetch(formspreeEndpoint, { method: "POST", headers: { Accept: "application/json", "Content-Type": "application/json" }, body: JSON.stringify(form) })
